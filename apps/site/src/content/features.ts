...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: "More places soon", p: ["Slack and Discord are next in line. Until their native adapters arrive, use Postbag’s signed webhook for services that accept its delivery envelope."] },
    ],
    faqs: [
